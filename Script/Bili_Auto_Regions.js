...
async function SwitchRegion(play) {
	const Group = $.read('BiliArea_Policy') || 'AsianMedia'; //Your blibli policy group name.
	...
	const DF = $.read('BiliArea_DF') || '🇨🇳 TW'; //Sub-policy name used after region is blocked(e.g. url 404)
